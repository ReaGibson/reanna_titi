...
def get_computer_choice():
    ...
    :return: str
    """
    return  random.choice (['Rock', 'Paper', 'Scissors']) #using 'choice' method to select one element from the list.
...
#Displaying what the user and computer have chosen using 'f' string
